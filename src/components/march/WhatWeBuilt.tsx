...
const builds = [
  ...
  { emoji: "📱", name: "Jenia Zimmerman", project: "Atta — Women's Health App", desc: "Launched on the App Store after 5 months of building with Lovable. 118 users in the first 3 days.", link: "https://apps.apple.com/app/atta-womens-health-assistant/id6758871646" },
